  ...
  return (
    <div>
      <FormLine>
        ...
        <div className="w-1/5 mr-4"><Dropdown items={visibility} prop={"visibility_" + prop} order={false} /></div>
        <div className="w-1/5 mr-4"><Dropdown items={required} prop={"required_" + prop} order={false} /></div>
